...
- a structured LLM research packet, proposal validator, executable research controls, paired
  baseline/candidate evaluation, and append-only theory ledger.
...
Version `0.1.0` is a minimal end-to-end slice. The next priorities are differential rule tests,
replayable decision probes, stronger imperfect-information agents, and a sandboxed candidate-code
path that still cannot alter the evaluator. See [ROADMAP.md](docs/ROADMAP.md).
